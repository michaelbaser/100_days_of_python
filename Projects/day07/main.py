...
top_level_folder = pathlib.Path.cwd() 

if str(top_level_folder) not in sys.path:
    sys.path.append(str(top_level_folder))
...
# Find module path
module_path = root_dir / "Projects" / "day07" / "General Code"
